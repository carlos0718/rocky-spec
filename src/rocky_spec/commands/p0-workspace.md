> Referencia de **rocky-spec** — Paso P0 del flujo de creación: detección de workspace y populado del perfil (solo primera ejecución).
...
- **Opción 1 / 2** → ver `.rocky-spec/reference/scan-strategies.md` sección "Estrategia A — Scan local".
...
- **Opción 3** → cascada de GitHub: `.rocky-spec/reference/scan-strategies.md` sección "Estrategia B — Cascada de GitHub".
