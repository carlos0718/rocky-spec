> Referencia de **rocky-spec** — Paso P4 del flujo de creación: recomendación y decisión de arquitectura.
...
Según el score y el tipo de proyecto, elegir de la lista completa en `.rocky-spec/reference/architectures.md` y mostrar la recomendación en este formato (el árbol de carpetas sale de `.rocky-spec/reference/architectures/codigo.md`):
