> Referencia de **rocky-spec** — árboles de carpetas para proyectos **creativos** (video ad/motion, social content batch, branding visual). Ver `.rocky-spec/reference/architectures.md` para la tabla de decisión.
...
├── 01-brief/
│   ├── BRIEF.md
│   └── client-.rocky-spec/reference/       ← assets que mandó el cliente
├── 02-.rocky-spec/reference/
