> Referencia de **rocky-spec** — Comportamiento transversal de menús (texto vs interactivo). Consultar cada vez que se presenta un menú al usuario, en cualquier paso del flujo P0–P8 o de los modos Adopción/Reanudación.
