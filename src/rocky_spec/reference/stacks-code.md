...
Este archivo lo usa `/rocky-spec` en el paso P2/P3 para sugerir y confirmar el stack.
...
**Si el backend u ORM elegido no está en estas tablas todavía**: no significa que el chequeo se deshabilite — ver el mecanismo de derivar + aprender en `.rocky-spec/commands/p6-p7-files-todo.md`. Deshabilitar (`echo "# deshabilitado — ..."`) queda solo para el caso raro donde ni la tabla ni el conocimiento del framework alcanzan para un patrón confiable.
