> Referencia de **rocky-spec** — Checklist de cierre. Se ejecuta al terminar tanto el flujo de creación (P8) como el Modo Adopción (MA-8): appendea al activity log y actualiza `profile.md`.
...
```json
{"date":"YYYY-MM-DD","skill":"rocky-spec","name":"<nombre>","type":"<tipo>","stack":{...},"architecture":"<arq>","path":"<absolute path>"}
```
