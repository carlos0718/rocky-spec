# Diccionario de keywords de activación — /rocky-spec

Este archivo documenta todas las frases y palabras clave que deben activar la skill `/rocky-spec`, organizadas por modo y por idioma. Sirve como referencia para ajustar el frontmatter `description` sin superar el límite de 1024 caracteres.
...
El usuario ya tiene un proyecto iniciado con `/rocky-spec` y quiere continuar desde donde quedó. La skill busca `.skill-state.json` para saber en qué punto retomar.
