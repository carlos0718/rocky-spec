...
> **Generado al cierre del challenge** con `/rocky-spec` (P8.5).
...
Este pattern se ofrece automáticamente en `/rocky-spec` cuando la descripción incluye:
