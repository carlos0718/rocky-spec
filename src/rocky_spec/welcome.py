...
COMMANDS = [
    ...
    ("rocky build [PATH] --values <json> --template <t> --output <ruta>", "Modo single-file: renderiza un solo template (MASTER.md.template, ACCESSIBILITY.md.template, PRACTICES.md.template) en vez del set fijo."),
