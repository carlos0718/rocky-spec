...
``.charless/`` dentro del repo del proyecto, versionado junto al código.
...
puntero hacia ``.charless/`` — nunca copia el contenido pesado dos veces.
...
class CommandDefinition:
    ...
    ``.charless/commands/<key>.md`` — texto plano, sin frontmatter, pensado
...
class IntegrationBase(ABC):
    ...
    def install(
        ...
        conocimiento compartido en ``.charless/``. Devuelve el manifiesto de
        instalación."""
