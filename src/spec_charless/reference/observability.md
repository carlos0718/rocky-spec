...
- **P6 (Genera archivos base)**: escribe `OBSERVABILITY.md` desde `.charless/templates/OBSERVABILITY.md.template`.
...
**El DSN es un secret** (aunque Sentry lo trate como semi-público) — va en `.env`, nunca hardcodeado. Ver `.charless/reference/security.md`.
...
**Qué nunca loguear** (ver `.charless/reference/security.md`): passwords, tokens completos, números de tarjeta, cualquier secret. Si hace falta debuggear su presencia, loguear `Boolean(value)`, no el valor.
