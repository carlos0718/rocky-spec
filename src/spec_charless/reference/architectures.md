# Arquitecturas — referencia completa para `/charless-ia`
...
- `.charless/reference/architectures/codigo.md` — Mini, Chico, Mediano, Grande, Libre
- `.charless/reference/architectures/creativo.md` — Video ad/motion, Social content batch, Branding visual
- `.charless/reference/architectures/hibrido.md` — Landing con animación 3D, Web inmersiva multi-escena
- `.charless/reference/architectures/aprendizaje.md` — `/learning-roadmap`
