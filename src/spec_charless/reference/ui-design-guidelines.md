...
Guía de referencia para P4.5 del flujo de `/charless-ia`. Contiene estilos visuales, paletas por tipo de producto, pares tipográficos, y anti-patrones comunes. Basado en los principios de Apple HIG, Material Design 3, y patrones de productos reales.
