> Referencia de **charless-ia** — árboles de carpetas para proyectos **híbridos** (landing con animación 3D, web inmersiva multi-escena). Ver `.charless/reference/architectures.md` para la tabla de decisión.
...
├── .charless/reference/                  ← inspiración visual
├── tests/
├── CONSTITUTION.md
├── AGENTS.md
├── CLAUDE.md
