...
La skill `/charless-ia` los consulta en el Paso 1 (descripción del proyecto). Si la descripción matchea las criterias de algún patrón → ofrece usarlo. Si no, sigue el flujo genérico.
