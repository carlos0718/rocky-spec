...
Este archivo lo usa `/charless-ia` para proyectos **híbridos** (web + motion/3D avanzado) o cuando un proyecto de código necesita animaciones más serias que Framer Motion.
