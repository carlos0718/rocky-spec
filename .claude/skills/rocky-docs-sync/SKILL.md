...
description: Trazabilidad de requisitos (RF-N/US-N/RNF-N), sincronización del README al completar una sección del TODO, y política de gestión de dependencias de rocky-spec. Usar al marcar el último checkbox de una sección de TODO.md (o de un archivo de todos/), al agregar un RF/US/RNF nuevo a SPEC.md, al preguntar qué tareas implementan un requisito, o antes de un release grande (auditoría de dependencias).
---

# /rocky-docs-sync — sincronización de documentación

> Migrado desde `AGENTS.md` (antes siempre cargado en cada sesión) — este contenido solo hace falta en los tres momentos que dispara la `description` de arriba, no en cada turno.
