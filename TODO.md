...
- [x] `rocky build` persiste los valores usados en `.rocky-spec/values.json`, mezclado con lo existente (US-26, RF-22)
- [ ] `rocky check drift` detecta secciones del template vigente ausentes en un archivo raíz ya existente (US-27, RF-22)
